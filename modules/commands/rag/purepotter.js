...
module.exports = {
	...
	run: async (bot, message, args) => {
        ...
        var potterembed = new Discord.RichEmbed()
            ...
            .setFooter("BOTete | Pure Potter Guide", bot.user.displayAvatarURL);
        ...
        var chimestryembed = new Discord.RichEmbed()
            ...
            .setFooter("BOTete search(AM_PHARMACY) | by Treorai", url.imgurls.browikipic);
        ...
        var cookembed = new Discord.RichEmbed()
            ...
            .setFooter("BOTete search(GN_MIX_COOKING) | by Treorai", url.imgurls.browikipic);
        ...
        var pharmacyembed = new Discord.RichEmbed()
            ...
            .setFooter("BOTete search(GN_S_PHARMACY) | by Treorai", url.imgurls.browikipic);
